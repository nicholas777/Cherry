...
class WorldLayer : public Layer {
  public:
    ...
    virtual void OnAttach() override {
        m_Atlas = new TextureAtlas("assets/tilemap_packed.png", 16, 16, 16 * 17,
                                   128, 17, 8);
        m_Camera =
            new Camera({0.0, 0.0}, -1.1, 1.1, 0.8, -0.8, 10, 0, {0, 1, 0});
...
Application *Cherry::CreateApplication() { return new Tests(); }
