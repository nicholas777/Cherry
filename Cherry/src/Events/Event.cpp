...
void Cherry::EventListener::InitEventListenerSystem()
{
	EventType types[] = { EventType::Unknown,
		EventType::GameStartEvent, EventType::GameWarningEvent, EventType::GameErrorEvent, EventType::GameShutdownEvent,
	...
	for (int i = 0; i < 16; i++)
	{
		EventListeners[types[i]] = new std::vector<Cherry::EventListener*>();
	}
}
