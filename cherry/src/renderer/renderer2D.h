...
namespace Cherry {
    ...
    public:
        ...
        // Rectangle
        static void DrawRect(const Vector2f& position, const Vector2f& size,
        ...
        static void DrawRect(const Matrix4x4f& transform, const Shared<Texture>& texture,
                             const Vector4f& color = { 1, 1, 1, 1 }, int entityID = -1);
        ...
        static void DrawRect(const Vector2f& position, const float& rotation, const Vector2f& size,
        ...
        // Text
        static void DrawChar(const Vector2f& coord1, const Vector2f& coord2,
                             const SubTexture& texture, const Vector4f& color = { 1, 1, 1, 1 });
