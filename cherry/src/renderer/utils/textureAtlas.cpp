...
namespace Cherry {
    ...
    TextureAtlas::TextureAtlas(const std::string& filepath, uint32_t textureWidth,
                               uint32_t textureHeight, uint32_t sheetWidth, uint32_t sheetHeight,
                               uint32_t texturesX, uint32_t texturesY) {
        CH_PROFILE_FUNC();
