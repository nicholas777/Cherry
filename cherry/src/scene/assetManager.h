...
namespace Cherry {
    enum class AssetType { Unknown = 0, Texture, Scene, Script };
    ...
    public:
        ...
        static uint32_t CreateTexture(uint32_t ID, const std::string& filepath,
                                      TextureParams params = TextureParams());

        static void CreateTextureIfNotExists(const std::string& filepath,
                                             TextureParams params = TextureParams());
        static void CreateTextureIfNotExists(uint32_t ID, const std::string& filepath,
                                             TextureParams params = TextureParams());
